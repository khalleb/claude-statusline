...
### 1. `/statusline-khalleb` command (inside Claude Code)

Type `/statusline-khalleb` in any Claude Code session to open the interactive configuration menu:
...
| Configuration UI | None | `/statusline-khalleb` command + TUI script |
